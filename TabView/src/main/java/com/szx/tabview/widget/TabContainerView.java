...
public class TabContainerView extends RelativeLayout {
    ...
    private void initStyle(Context context, AttributeSet attrs) {
        ...
        tabHeight = typedArray.getDimensionPixelSize(R.styleable.TabContainerViewStyle_tabHeight, DisplayUtil.dip2px(context, 49));
        drawableTo = typedArray.getInt(R.styleable.TabContainerViewStyle_drawableTo, DisplayUtil.dip2px(context, 1));
        tabBgColor = typedArray.getColor(R.styleable.TabContainerViewStyle_tabBgColor, Color.BLACK);
    ...
    public void setAdapter(BaseAdapter baseAdapter, int index) {
        ...
        tabHost.addTabs(baseAdapter, textSize, textColor, selectedTextColor, drawablePadding, iconWidth, iconHeight, tabHeight, drawableTo, tabBgColor);

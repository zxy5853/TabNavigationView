...
public class TabHost {
    ...
    public void addTabs(BaseAdapter baseAdapter, int textSize, int textColor, int selectedTextColor, int drawablePadding, int iconWidth, int iconHeight, int tabHeight, int drawableTo, int tabBgColor) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            Tab tab = new Tab(context, textArray[i], textSize, textColor, selectedTextColor, drawablePadding, iconWidth, iconHeight, iconImageArray[i], selectedIconImageArray[i], i, hasMsg, tabHeight, drawableTo,tabBgColor);
            addTab(tab);
        }
    }
